...
public class TomSawyerFlatMapApp
{
  public static void main(String[] args) throws IOException
  {
    String path = "/Users/kbui/GoToDev/Tutorials/src/main/java/com/stream/files/";

    Stream<String> stream1 = Files.lines(Paths.get(path + "TomSawyer_01.txt"));
    Stream<String> stream2 = Files.lines(Paths.get(path + "TomSawyer_02.txt"));
    Stream<String> stream3 = Files.lines(Paths.get(path + "TomSawyer_03.txt"));
    Stream<String> stream4 = Files.lines(Paths.get(path + "TomSawyer_04.txt"));
